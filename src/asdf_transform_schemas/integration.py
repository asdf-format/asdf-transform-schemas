...
def get_resource_mappings():
    resources_root = importlib.resources.files(asdf_transform_schemas) / "resources"
    ...
    return [
        DirectoryResourceMapping(
            resources_root / "stsci.edu" / "schemas", "http://stsci.edu/schemas/asdf/transform/", recursive=True
        ),
        DirectoryResourceMapping(
            resources_root / "asdf-format.org" / "manifests", "asdf://asdf-format.org/transform/manifests/"
        ),
    ]
